...
COPY --from=darwin /output/ffmpeg-8.1.1-darwin-x86_64.tar.gz /build/ffmpeg-8.1.1-darwin-x86_64.tar.gz

CMD ["cp", "/build/ffmpeg-8.1.1-darwin-x86_64.tar.gz", "/output"]
