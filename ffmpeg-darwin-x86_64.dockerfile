...
COPY --from=darwin /output/ffmpeg-${FFMPEG_VERSION}-darwin-x86_64.tar.gz /build/ffmpeg-${FFMPEG_VERSION}-darwin-x86_64.tar.gz

CMD ["sh", "-c", "cp /build/ffmpeg-${FFMPEG_VERSION}-darwin-x86_64.tar.gz /output"]
