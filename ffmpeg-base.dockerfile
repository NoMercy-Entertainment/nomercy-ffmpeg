...
RUN \
    ...
    && tar -xvf libiconv.tar.gz >/dev/null 2>&1 \
    && rm libiconv.tar.gz \
    && mv libiconv-* iconv \
    ...
    && tar -xvf fftw3.tar.gz >/dev/null 2>&1 \
    && rm fftw3.tar.gz \
    && mv fftw-${fftw3_version} fftw3 \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf freetype.tar.gz >/dev/null 2>&1 \
    && rm freetype.tar.gz \
    && mv freetype-$(echo ${freetype_version} | tr '-' '.') freetype \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xJf fribidi-${fribidi_version}.tar.xz >/dev/null 2>&1 \
    && rm fribidi-${fribidi_version}.tar.xz \
    && mv fribidi-${fribidi_version} fribidi \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && (cd openssl && git submodule update --init --recursive --depth=1 >/dev/null 2>&1) \
    && echo "------------------------------------------------------" \
    ...
    && tar -xvf libcddb.tar.gz >/dev/null 2>&1 \
    && rm libcddb.tar.gz \
    && mv libcddb-* libcddb \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf mp3lame.tar.gz >/dev/null 2>&1 \
    && rm mp3lame.tar.gz \
    && mv lame-${mp3lame_version} lame \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf fdk-aac.tar.gz >/dev/null 2>&1 \
    && rm fdk-aac.tar.gz \
    && mv fdk-aac-* fdk-aac \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf xvidcore.tar.gz >/dev/null 2>&1 \
    && rm xvidcore.tar.gz \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf libwebp.tar.gz >/dev/null 2>&1 \
    && rm libwebp.tar.gz \
    && mv libwebp-${libwebp_version} libwebp \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xzf jpegsrc.v${jpegsrc_version}.tar.gz >/dev/null 2>&1 \
    && mv jpeg-${jpegsrc_version} jpeg \
    && rm jpegsrc.v${jpegsrc_version}.tar.gz \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xvzf giflib-5.2.2.tar.gz >/dev/null 2>&1 \
    && mv giflib-5.2.2 giflib \
    ...
    && tar -xvf libpng-1.6.47.tar.gz >/dev/null 2>&1 \
    && mv libpng-1.6.47 libpng \
    && rm -f libpng-1.6.47.tar.gz \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && (cd spirv-cross && git checkout ${spirv_cross_checkout} >/dev/null 2>&1) \
    && echo "✅ Download completed successfully" \
    && echo "------------------------------------------------------" \
    && echo "------------------------------------------------------" \
    ...
    && tar -xjf ffmpeg.tar.bz2 >/dev/null 2>&1 \
    && rm ffmpeg.tar.bz2 \
